...
public class VentaDao {
    ...
    public Venta BuscarVenta(int id) throws ClassNotFoundException{
        Venta cl = new Venta();
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) throws ClassNotFoundException {
        try {
            Date date = new Date();
